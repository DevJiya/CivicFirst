...
export class TranslationEngine {
  ...
  private static readonly translations: Record<string, Record<string, string>> = {
    ...
    'nav.askCivicFirst':   { en: 'Ask CivicFirst', hi: 'CivicFirst से पूछें', es: 'Preguntar',  ar: 'اسأل',          fr: 'Demander',        de: 'Fragen',      zh: '提问' },
    ...
    'hero.subtitle':    { en: 'CivicFirst guides you through every step of the election process — from voter registration to final results.', hi: 'CivicFirst आपको मतदाता पंजीकरण से अंतिम परिणाम तक हर कदम पर मार्गदर्शन करता है।', es: 'CivicFirst le guía en cada paso del proceso electoral.', ar: 'يرشدك CivicFirst خلال كل خطوة في العملية الانتخابية.', fr: 'CivicFirst vous guide à travers chaque étape du processus électoral.', de: 'CivicFirst führt Sie durch jeden Schritt des Wahlprozesses.', zh: 'CivicFirst 指导您完成选举过程的每一步。' },
    ...
    'feature.chat.title':          { en: 'Ask CivicFirst',            hi: 'CivicFirst से पूछें',       es: 'Preguntar a CivicFirst', ar: 'اسأل CivicFirst',         fr: 'Demandez à CivicFirst',      de: 'CivicFirst fragen',       zh: '询问CivicFirst' },
    ...
    'chat.title':                  { en: 'Ask CivicFirst',            hi: 'CivicFirst से पूछें',          es: 'Preguntar a CivicFirst', ar: 'اسأل CivicFirst',          fr: 'Demandez à CivicFirst',    de: 'CivicFirst fragen',  zh: '询问CivicFirst' },
    ...
    'chat.panel.disclaimer':       { en: 'AI can make mistakes. CivicFirst only covers election processes.', hi: 'AI गलतियाँ कर सकता है।', es: 'La IA puede cometer errores.', ar: 'قد يخطئ الذكاء الاصطناعي.', fr: 'L\'IA peut faire des erreurs.', de: 'KI kann Fehler machen.', zh: 'AI 可能会犯错。' },
    ...
    'about.title':                 { en: 'About CivicFirst',          hi: 'CivicFirst के बारे में',      es: 'Acerca de CivicFirst',   ar: 'حول CivicFirst',          fr: 'À propos de CivicFirst',   de: 'Über CivicFirst',    zh: '关于CivicFirst' },
